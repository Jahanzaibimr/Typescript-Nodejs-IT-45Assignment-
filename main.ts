...
let personName ="Jahanzaib Imran";
...
let favNumber = 9
let message = "Mine favourate number is"
...
let friendsName = ["Ahmed","Hamza","Usama","Ayesha"];
...
let friendsName = ["Ahmed","Arif","Faisal","Faiza"];

friendsName.forEach(friendName => console.log(`Hello ${friendName}, How you doin`));
...
let guessList = ["Ahmed","Arif","Faiz","Faiza"];

guessList.forEach(eachGuest =>console.log(`Hello ${eachGuest}, would you like to dinner with me?`));
...
let guessList = ["Faiz","Faizan","Ayesha","Areeb"];
...
guessList.forEach(guest => console.log(`Hello ${guest}, would you like to dinner with me?`));
...
let guessList = ["Aslam","Ahmed","Basit","Areeb"];

// not come bigger party variable
let notCome =guessList[0];
...
guessList.forEach(oneguest => console.log(`Hello ${oneguest}, would you like to dinner with me?`));
...
let guest: string[] = ["Ahmed","Akram","Muneeb","Sami","Aslam"];
...
let placesToVisit: string[] = ["Tokyo","America","China","Japan","Pakistan"];
...
let invitation: string[] = ["Akeel","Faiz"];
...
let country: string[] =["Pakistan","Newyork","India","Japan","China"];
...
let person: {name: string, Gendername: string, age: number} = {name:"Jahanzaib", Gendername:"Male", age: 22}
console.log(person);

// TASK 22
// Intentional Error: If you haven’t received an array index error in one of your programs yet, try to make one happen. Change an index in one of your programs to produce an index error. Make sure you correct the error before closing the program.

let days: string[] =["Saturday","Sunday","Monday","Tuesday","Wednesday","Thursday","Friday"];
// console.log(days{7});
...
let name_1 : string = "Jahanzaib"
let name_2 : string = "Ali"
let name_3 : string = "Ahmed"
...
let country: string[] =["Pakistan","Japan","India","America"]
...
let favourate_fruits: string[]=["mango","orange","berry","apple","peach"]
...
let users : string [] =["admin","ahmed","faisal","laiba","faiza"]
...
let users : string [] =["aslam","ahmed","faisal","laiba","faiza"]
...
let current_users: string[] =["admin","Aslam","Arif","Faisal","aliza"]
let new_users : string[] = ["admin","aliza","Areeb","Basit","Faiza"]
...
let favourate_pizza : string[] =["pepperoni","chicken","cheese"]

for (let pizza of favourate_pizza){
    console.log(pizza)
}
console.log("\n")
...
function show_magicians(magicians: string[]): void{
   ...
   const magician:string[] = ["arif","faisal","laiba"];
...
const magicians2: string[] = ["arham","muskan","asim"];
...
const magicians3: string[] = ["atif","faisal","laiba"];
